  ...
  return (
    <section className="planes" id="planes">
      ...
      <div className="planes-header" data-aos="zoom-in">
        <span className="planes-tag">Planes</span>

        <h2>Elegí el plan ideal para tu kiosco</h2>

        <p>Comenzá gratis y actualizá cuando necesites más funciones.</p>
      </div>
